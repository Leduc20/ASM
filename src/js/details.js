...
// <div class="mx-auto max-w-5xl px-4 mt-[100px]">
// <div>   
//         <h2 class="font-bold text-[40px] md:text-[40px] mb-3"><a href="">${productPost.title}</a></h2>
//     <div class="py-3 flex justify-start">
//         <button class="bg-[#FF7C7C] rounded-[25px] text-[18px] w-[95px] h-[25px] md:w-[85px] text-white mr-4">${productPost.date}</button>
//         <a href="">
//             <span class="text-[22px] md:text-[20px]">${productPost.short}</span>
//         </a>
//     </div>
//     <p class="mt-3 mb-[35px]">
//         ${productPost.infor}
